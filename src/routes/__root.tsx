  ...
  head: () => ({
    meta: [
      ...
      { title: "Solo System — Hunter Training" },
      {
        name: "description",
        content:
          "A Solo Leveling-inspired holographic gym training system. Accept daily quests, level up, ascend ranks.",
      },
      { name: "author", content: "The System" },
      { name: "theme-color", content: "#0a1530" },
      { property: "og:title", content: "Solo System — Hunter Training" },
      {
        property: "og:description",
        content: "Train like a Hunter. Accept daily quests. Level up.",
      },
